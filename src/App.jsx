...
function App() {
  ...
  const [ref3, visible3] = useOnScreen({ threshold: 0.5 });
  const [ref4, visible4] = useOnScreen({ threshold: 0.8 });
  return (
    <div className="App">
      <Header />
      ...
      <section className="sec-2">
        <div className="about">
          <div className={`about-inner ${visible3? 'visible3': ''}`} ref={ref3}>
            <div className="about-title">about</div>
            <div className="about-content">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Enim,
              numquam quos. Aspernatur labore sequi magni repellendus odio.
              Laboriosam quibusdam quod architecto maxime eveniet corporis.
              Incidunt deserunt excepturi, non quia reprehenderit autem illum
              quis voluptatum aliquam eligendi quasi odio sequi, alias tempora
              dolorem laboriosam consequatur! Maiores nobis qui excepturi
              consequatur, ipsum a sint similique voluptatum id molestiae, non
              animi amet ullam sequi! Eius saepe ut quas doloremque numquam, ab
              atque, odit at odio ad praesentium dignissimos facere, cupiditate
              soluta itaque. Magni provident eos distinctio necessitatibus quae
              hic accusantium nihil nemo expedita?
            </div>
          </div>
        ...
        <div className={`repair ${visible4?'visible4' : ''}`} ref={ref4}>
          <div className="left">
            <div className="repair-title">repair</div>
            <div className="repair-content">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Possimus
              adipisci dolor dicta error eaque doloremque eum. Voluptatem
              officia quae repudiandae in maxime aliquid, minus quasi laudantium
              sunt quis ipsum dicta?
            </div>
            <div className="more">
              <span>more</span>
            </div>
        ...
        <div className="collection">
          ...
          <div className="content">
            <p>
              ...
              sapiente nostrum eaque nemo eum dolorem excepturi itaque animi ea
              explicabo?
            </p>
          </div>
        </div>
